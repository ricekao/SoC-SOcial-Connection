...
-- check-in table: bright_checkin_top5000
-- co-occurrence table: bright_top5000 
-- friendship table: bright_friends_top5000

-- database name: rice_schema / rice_brightkite
-- dataset name: gowalla / bright   (venue, checkin_count)
-- threshold(social_strength): gowalla:4.28 ; brightkite: 2.95

/*****************************************************************/



-- STEP 1: calculate personal_background (p_prob) in Formula 3.
...
-- STEP 2: calculate global_background (l_prob) in Formula 6.
...
-- location entropy (l_entropy) in Formula 7.
...
-- STEP 3: calculate w_g: the weight of global background in Formula 11.
...
-- We already have this table: bright_top5000 in SoC-java at "runCoOccurrence" function
-- We add indexes here
...
-- STEP 6: calculate w_t: the weight of temporal factor in Formula 14.
...
-- STEP 7: aggregate co-occurrence_temporal with max_w_p and w_g

-- aggregate co-occurrence_temporal with max_w_p
...
-- aggregate co-occurrence_temporal_personal with w_g
...
-- STEP 8: calculate social strength
...
-- STEP 9: Evaluate with threshold and friendship table 
-- threshold = 4.28 (gowalla), 2.95 (brightkite)
...
-- STEP 10: calculate precision, recall
